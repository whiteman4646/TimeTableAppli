...
public class ConfigCheckBoxColumn extends TableColumn<Timetable, Boolean> {
	public ConfigCheckBoxColumn() {
        // Timetableのcheckedプロパティと紐づける
        this.setCellValueFactory(new PropertyValueFactory<>("check"));

        this.setCellFactory(column -> {

            // CheckBoxTableCellの挙動を定義する
            CheckBoxTableCell<Timetable, Boolean> cell = new CheckBoxTableCell<Timetable, Boolean>(index -> {
