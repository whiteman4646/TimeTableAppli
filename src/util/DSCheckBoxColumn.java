...
public class DSCheckBoxColumn extends TableColumn<Subject, Boolean> {
	public DSCheckBoxColumn() {
		...
		this.setCellFactory(column -> {
			...
			CheckBoxTableCell<Subject, Boolean> cell = new CheckBoxTableCell<Subject, Boolean>(index -> {
